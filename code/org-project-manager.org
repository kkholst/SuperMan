  ...
  (defun org-pro-help-mode ()
    ...
    (other-window -1) 
        ...
        (org-defkey org-columns-map "q" (lambda ()          
                                          ...
                                          (if (get-buffer org-pro-helpbuf) (kill-buffer org-pro-helpbuf))
                                          (delete-frame)
                                          ))
...
#+RESULTS[0f49d7e1c35d11025473376c5cbc276e44ebb28f]:
...
(defun org-pro-view-mode (&optional status) 
  ...
  (let ()
    ...
    (if (get-buffer org-pro-viewbuf) (progn
...
#+RESULTS[5e5629a73f23d6819d30aa874ca49b0cefa1f9ac]:
: org-pro-git-revision-at-point
