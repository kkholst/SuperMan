...
(org-columns)
(setq org-columns-default-format "%20ITEM(Title) %8TODO(ToDo) %GitStatus %50LastCommit(Last Commit)")
(org-defkey org-columns-map "\r" 'org-pro-column-action)
...
#+RESULTS[454e524f322362b95002a57a695a69a542f38d9d]:
